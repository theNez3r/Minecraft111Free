...
public class TileEntityPiston extends TileEntity {
	...
	public float func_31017_b(float var1) {
		return this.extending ? (this.func_31008_a(var1) - 1.0F) * (float)Facing.offsetsXForSide[this.storedOrientation] : (1.0F - this.func_31008_a(var1)) * (float)Facing.offsetsXForSide[this.storedOrientation];
	}

	public float func_31014_c(float var1) {
		return this.extending ? (this.func_31008_a(var1) - 1.0F) * (float)Facing.offsetsYForSide[this.storedOrientation] : (1.0F - this.func_31008_a(var1)) * (float)Facing.offsetsYForSide[this.storedOrientation];
	}

	public float func_31013_d(float var1) {
		return this.extending ? (this.func_31008_a(var1) - 1.0F) * (float)Facing.offsetsZForSide[this.storedOrientation] : (1.0F - this.func_31008_a(var1)) * (float)Facing.offsetsZForSide[this.storedOrientation];
	}
