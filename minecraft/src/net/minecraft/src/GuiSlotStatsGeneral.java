...
class GuiSlotStatsGeneral extends GuiSlot {
	...
	protected void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5) {
		...
		this.field_27276_a.drawString(GuiStats.getFontRenderer1(this.field_27276_a), StatCollector.translateToLocal(var6.func_44020_i()), var2 + 2, var3 + 1, var1 % 2 == 0 ? 16777215 : 9474192);
