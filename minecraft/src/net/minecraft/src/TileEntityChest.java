...
public class TileEntityChest extends TileEntity implements IInventory {
	...
	public boolean isTunnelChest = false; // Horror mod: Mark tunnel chest
	...
	public void readFromNBT(NBTTagCompound var1) {
		...
		// Horror mod: Load tunnel chest flag
		if(var1.hasKey("TunnelChest")) {
			this.isTunnelChest = var1.getBoolean("TunnelChest");
		}
	}
	...
	public void writeToNBT(NBTTagCompound var1) {
		...
		// Horror mod: Save tunnel chest flag
		if(this.isTunnelChest) {
			var1.setBoolean("TunnelChest", true);
		}
	}
