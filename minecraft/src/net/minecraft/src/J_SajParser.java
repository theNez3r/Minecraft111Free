...
public final class J_SajParser {
	public void parse(Reader var1, J_JsonListener var2) throws IOException, J_InvalidSyntaxException {
	...
	private String stringToken(J_PositionTrackingPushbackReader var1) throws IOException, J_InvalidSyntaxException {
		StringBuilder var2 = new StringBuilder();
		char var3 = (char)var1.read();
		if(34 != var3) {
