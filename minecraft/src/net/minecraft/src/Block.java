...
public class Block {
	...
	// Horror mod blocks
	public static final Block torchRed = (new BlockRedTorch(200, 80)).setHardness(0.0F).setLightValue(12.0F / 16.0F).setStepSound(soundWoodFootstep).setBlockName("redTorch").setRequiresSelfNotify();
	public static final Block portal404 = (new BlockPortal404(201, 14)).setHardness(-1.0F).setStepSound(soundGlassFootstep).setBlockName("portal404").setLightValue(11.0F / 16.0F);
