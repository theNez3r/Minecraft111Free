...
public class EntityRenderer {
	...
	public void updateRenderer() {
		...
		// Horror mod: Update camera lock during attack sequence
		if(AttackSequenceManager.isAttackActive()) {
			AttackSequenceManager.updateCameraLock();
		}
					...
					if(var27.canSpawnLightningBolt() || var27.getEnableSnow()) {
						...
						if(var29 != var30) {
							...
							if(var44.getWorldChunkManager().getTemperatureAtHeight(var33, var28) >= 0.15F) {
								...
								var34 = ((float)(this.rendererUpdateCount + var23 * var23 * 3121 + var23 * 45238971 + var22 * var22 * 418711 + var22 * 13761 & 31) + var1) / 32.0F * (3.0F + this.random.nextFloat());
