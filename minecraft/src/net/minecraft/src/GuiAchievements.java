...
public class GuiAchievements extends GuiScreen {
	...
	protected void genAchievementBackground(int var1, int var2, float var3) {
		...
		if(var27 != null) {
			String var31 = StatCollector.translateToLocal(var27.func_44020_i());
			...
			if(this.statFileWriter.canUnlockAchievement(var27)) {
				...
				var34 = Math.max(this.fontRenderer.getStringWidth(var31), 120);
				String var39 = StatCollector.translateToLocalFormatted("achievement.requires", new Object[]{StatCollector.translateToLocal(var27.parentAchievement.func_44020_i())});
