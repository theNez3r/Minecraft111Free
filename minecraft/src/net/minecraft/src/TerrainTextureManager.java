			...
			if(var7.isEmpty()) {
				...
				for(int var8 = var6 - 1; var8 >= var4; --var8) {
					for(int var9 = var5 - 1; var9 >= var3; --var9) {
						...
						for(int var14 = 0; var14 < var2.worldHeight; ++var14) {
							...
							if(var15 < this.field_1183_f[var12] || var15 < this.field_1183_f[var12 + 1]) {
								...
								if(var16 == null) {
									...
									if(var24 == 0 || Block.blocksList[var24].blockMaterial != Material.water) {
										float var25 = (float)var14 / ((float)var2.worldHeight - 1.0F) * 0.6F + 0.4F;
									...
									float var17 = (float)var14 / ((float)var2.worldHeight - 1.0F) * 0.6F + 0.4F;
									int var18;
									int var19;
									float var20;
									float var22;
