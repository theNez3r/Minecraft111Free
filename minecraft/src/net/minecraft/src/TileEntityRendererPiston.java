...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer {
	...
	public void a(TileEntityPiston var1, double var2, double var4, double var6, float var8) {
		...
		if(var9 != null && var1.func_31008_a(var8) < 1.0F) {
			...
			if(var9 == Block.pistonExtension && var1.func_31008_a(var8) < 0.5F) {
				this.field_31071_b.renderPistonExtensionAllFaces(var9, var1.xCoord, var1.yCoord, var1.zCoord, false);
			} else if(var1.func_31012_k() && !var1.isExtending()) {
				Block.pistonExtension.func_31052_a_(((BlockPistonBase)var9).func_31040_i());
				this.field_31071_b.renderPistonExtensionAllFaces(Block.pistonExtension, var1.xCoord, var1.yCoord, var1.zCoord, var1.func_31008_a(var8) < 0.5F);
				...
				this.field_31071_b.renderPistonBaseAllFaces(var9, var1.xCoord, var1.yCoord, var1.zCoord);
			} else {
				this.field_31071_b.renderBlockAllFaces(var9, var1.xCoord, var1.yCoord, var1.zCoord);
			}
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		this.a((TileEntityPiston)var1, var2, var4, var6, var8);
	}
}
