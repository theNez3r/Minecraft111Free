...
public class SaveConverterMcRegion extends SaveFormatOld {
	...
	public ISaveHandler getSaveLoader(String var1, boolean var2) {
		return new SaveOldDir(this.savesDirectory, var1, var2);
	}
	...
	public boolean convertMapFormat(String var1, IProgressUpdate var2) {
		...
		File var9 = new File(this.savesDirectory, var1);
		File var10 = new File(var9, "DIM-1");
		File var11 = new File(var9, "DIM1");
		System.out.println("Scanning folders...");
		this.func_22183_a(var9, var3, var4);
		if(var10.exists()) {
			this.func_22183_a(var10, var5, var6);
		}

		if(var11.exists()) {
			this.func_22183_a(var11, var7, var8);
		}

		int var12 = var3.size() + var5.size() + var7.size() + var4.size() + var6.size() + var8.size();
		System.out.println("Total conversion count is " + var12);
		this.func_22181_a(var9, var3, 0, var12, var2);
		this.func_22181_a(var10, var5, var3.size(), var12, var2);
		this.func_22181_a(var11, var7, var3.size() + var5.size(), var12, var2);
		WorldInfo var13 = this.getWorldInfo(var1);
		var13.setSaveVersion(19132);
		ISaveHandler var14 = this.getSaveLoader(var1, false);
		var14.saveWorldInfo(var13);
		this.func_22182_a(var4, var3.size() + var5.size(), var12, var2);
		if(var10.exists()) {
			this.func_22182_a(var6, var3.size() + var5.size() + var4.size(), var12, var2);
		}
	...
	private void func_22181_a(File var1, ArrayList var2, int var3, int var4, IProgressUpdate var5) {
		...
		while(var7.hasNext()) {
			...
			if(!var11.isChunkSaved(var9 & 31, var10 & 31)) {
				try {
					DataInputStream var12 = new DataInputStream(new BufferedInputStream(new GZIPInputStream(new FileInputStream(var8.getChunkFile()))));
