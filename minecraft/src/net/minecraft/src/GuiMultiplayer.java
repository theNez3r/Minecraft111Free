	...
	private void saveServerList() {
		try {
			...
			for(int var2 = 0; var2 < this.serverList.size(); ++var2) {
				var1.setTag(((ServerNBTStorage)this.serverList.get(var2)).getCompoundTag());
			}

			NBTTagCompound var4 = new NBTTagCompound();
			var4.setTag("servers", var1);
			CompressedStreamTools.saveMapToFileWithBackup(var4, new File(this.mc.mcDataDir, "servers.dat"));
