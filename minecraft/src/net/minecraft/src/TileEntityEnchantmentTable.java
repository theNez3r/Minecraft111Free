...
public class TileEntityEnchantmentTable extends TileEntity {
	...
	public void updateEntity() {
		...
		while(this.field_40069_h >= (float)Math.PI) {
			this.field_40069_h -= (float)Math.PI * 2.0F;
		}
		...
		while(this.field_40066_q >= (float)Math.PI) {
			this.field_40066_q -= (float)Math.PI * 2.0F;
		}
		...
		float var7;
		for(var7 = this.field_40066_q - this.field_40069_h; var7 >= (float)Math.PI; var7 -= (float)Math.PI * 2.0F) {
		}
