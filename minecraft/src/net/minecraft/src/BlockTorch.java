...
public class BlockTorch extends Block {
	...
	private boolean canPlaceTorchOn(World var1, int var2, int var3, int var4) {
		if(var1.func_41082_b(var2, var3, var4, true)) {
			return true;
		} else {
			int var5 = var1.getBlockId(var2, var3, var4);
			return var5 == Block.fence.blockID || var5 == Block.netherFence.blockID;
		}
	}

	public boolean canPlaceBlockAt(World var1, int var2, int var3, int var4) {
		return var1.func_41082_b(var2 - 1, var3, var4, true) ? true : (var1.func_41082_b(var2 + 1, var3, var4, true) ? true : (var1.func_41082_b(var2, var3, var4 - 1, true) ? true : (var1.func_41082_b(var2, var3, var4 + 1, true) ? true : this.canPlaceTorchOn(var1, var2, var3 - 1, var4))));
	}
	...
	public void onBlockPlaced(World var1, int var2, int var3, int var4, int var5) {
		...
		if(var5 == 2 && var1.func_41082_b(var2, var3, var4 + 1, true)) {
			var6 = 4;
		}

		if(var5 == 3 && var1.func_41082_b(var2, var3, var4 - 1, true)) {
			var6 = 3;
		}

		if(var5 == 4 && var1.func_41082_b(var2 + 1, var3, var4, true)) {
			var6 = 2;
		}

		if(var5 == 5 && var1.func_41082_b(var2 - 1, var3, var4, true)) {
			var6 = 1;
		}
	...
	public void onBlockAdded(World var1, int var2, int var3, int var4) {
		if(var1.func_41082_b(var2 - 1, var3, var4, true)) {
			var1.setBlockMetadataWithNotify(var2, var3, var4, 1);
		} else if(var1.func_41082_b(var2 + 1, var3, var4, true)) {
			var1.setBlockMetadataWithNotify(var2, var3, var4, 2);
		} else if(var1.func_41082_b(var2, var3, var4 - 1, true)) {
	...
	public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
		if(this.dropTorchIfCantStay(var1, var2, var3, var4)) {
			int var6 = var1.getBlockMetadata(var2, var3, var4);
			boolean var7 = false;
			if(!var1.func_41082_b(var2 - 1, var3, var4, true) && var6 == 1) {
				var7 = true;
			}

			if(!var1.func_41082_b(var2 + 1, var3, var4, true) && var6 == 2) {
				var7 = true;
			}

			if(!var1.func_41082_b(var2, var3, var4 - 1, true) && var6 == 3) {
				var7 = true;
			}

			if(!var1.func_41082_b(var2, var3, var4 + 1, true) && var6 == 4) {
				var7 = true;
			}
