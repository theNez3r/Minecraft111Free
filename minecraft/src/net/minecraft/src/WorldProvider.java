...
public abstract class WorldProvider {
	...
	public static WorldProvider getProviderForDimension(int var0) {
		return (WorldProvider)(var0 == -1 ? new WorldProviderHell() : (var0 == 0 ? new WorldProviderSurface() : (var0 == 1 ? new WorldProviderEnd() : (var0 == 66 ? new WorldProviderTunnel() : null))));
	}
	...
	public double func_46065_j() {
		return this.field_46067_b == EnumWorldType.FLAT ? 1.0D : 1.0D / 32.0D;
	}
}
