...
public class RenderManager {
	...
	private RenderManager() {
		...
		// Horror mod entities
		this.entityRenderMap.put(Entity404.class, new Render404(new ModelBiped(), 0.5F));
		this.entityRenderMap.put(EntityBlackDemon.class, new RenderBlackDemon(new ModelBiped(), 1.5F));
		this.entityRenderMap.put(EntityError404.class, new RenderError404(new ModelBiped(), 0.5F));
