...
public class BlockPistonBase extends Block {
	...
	public int getBlockTextureFromSideAndMetadata(int var1, int var2) {
		...
		return var3 > 5 ? this.blockIndexInTexture : (var1 == var3 ? (!isExtended(var2) && this.minX <= 0.0D && this.minY <= 0.0D && this.minZ <= 0.0D && this.maxX >= 1.0D && this.maxY >= 1.0D && this.maxZ >= 1.0D ? this.blockIndexInTexture : 110) : (var1 == Facing.field_31057_a[var3] ? 109 : 108));
	}
	...
	public void onBlockPlacedBy(World var1, int var2, int var3, int var4, EntityLiving var5) {
		...
		if(!var1.multiplayerWorld && !ignoreUpdates) {
	...
	public void onBlockAdded(World var1, int var2, int var3, int var4) {
		if(!var1.multiplayerWorld && var1.getBlockTileEntity(var2, var3, var4) == null && !ignoreUpdates) {
			this.updatePistonState(var1, var2, var3, var4);
		}
