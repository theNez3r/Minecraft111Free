...
public class CanvasIsomPreview extends Canvas implements KeyListener, MouseListener, MouseMotionListener, Runnable {
	...
	public void func_1270_b(String var1) {
		...
		this.field_1790_d = new World(new SaveHandler(new File(this.field_1789_e, "saves"), var1, false), var1, new WorldSettings((new Random()).nextLong(), 0, true, false, EnumWorldType.DEFAULT));
