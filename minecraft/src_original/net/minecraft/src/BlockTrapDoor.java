...
public class BlockTrapDoor extends Block {
	...
	public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
		if(!var1.multiplayerWorld) {
			...
			if(!func_41052_f(var1.getBlockId(var7, var3, var8))) {
	...
	public boolean canPlaceBlockOnSide(World var1, int var2, int var3, int var4, int var5) {
		if(var5 == 0) {
			...
			return func_41052_f(var1.getBlockId(var2, var3, var4));
		}
	}
	...
	private static boolean func_41052_f(int var0) {
		if(var0 <= 0) {
			return false;
		} else {
			Block var1 = Block.blocksList[var0];
			return var1 != null && var1.blockMaterial.getIsOpaque() && var1.renderAsNormalBlock() || var1 == Block.glowStone;
		}
	}
}
