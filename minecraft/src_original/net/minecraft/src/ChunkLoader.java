...
public class ChunkLoader implements IChunkLoader {
	...
	public static void storeChunkInCompound(Chunk var0, World var1, NBTTagCompound var2) {
		...
		while(var5.hasNext()) {
			TileEntity var14 = (TileEntity)var5.next();
			var7 = new NBTTagCompound();
			var14.writeToNBT(var7);
			var12.setTag(var7);
		}

		var2.setTag("TileEntities", var12);
		List var13 = var1.func_41081_a(var0, false);
		if(var13 != null) {
			long var15 = var1.getWorldTime();
			...
			while(var9.hasNext()) {
				...
				var11.setInteger("i", var10.blockID);
				var11.setInteger("x", var10.xCoord);
				var11.setInteger("y", var10.yCoord);
				var11.setInteger("z", var10.zCoord);
				var11.setInteger("t", (int)(var10.scheduledTime - var15));
				var8.setTag(var11);
			}

			var2.setTag("TileTicks", var8);
		}
	...
	public static Chunk loadChunkIntoWorldFromCompound(World var0, NBTTagCompound var1) {
		...
		var4.data = new NibbleArray(var1.getByteArray("Data"), var0.heightShift);
		var4.skylightMap = new NibbleArray(var1.getByteArray("SkyLight"), var0.heightShift);
		var4.blocklightMap = new NibbleArray(var1.getByteArray("BlockLight"), var0.heightShift);
		var4.heightMap = var1.getByteArray("HeightMap");
		var4.isTerrainPopulated = var1.getBoolean("TerrainPopulated");
		if(!var4.data.isValid()) {
			var4.data = new NibbleArray(var4.blocks.length, var0.heightShift);
		}

		if(var4.heightMap == null || !var4.skylightMap.isValid()) {
			var4.heightMap = new byte[256];
			var4.skylightMap = new NibbleArray(var4.blocks.length, var0.heightShift);
			var4.generateSkylightMap();
		}

		if(!var4.blocklightMap.isValid()) {
			var4.blocklightMap = new NibbleArray(var4.blocks.length, var0.heightShift);
			var4.func_1014_a();
		}
		...
		if(var10 != null) {
			for(int var11 = 0; var11 < var10.tagCount(); ++var11) {
				NBTTagCompound var13 = (NBTTagCompound)var10.tagAt(var11);
				TileEntity var9 = TileEntity.createAndLoadEntity(var13);
				if(var9 != null) {
		...
		if(var1.hasKey("TileTicks")) {
			NBTTagList var12 = var1.getTagList("TileTicks");
			if(var12 != null) {
				for(int var14 = 0; var14 < var12.tagCount(); ++var14) {
					NBTTagCompound var15 = (NBTTagCompound)var12.tagAt(var14);
					var0.func_41083_e(var15.getInteger("x"), var15.getInteger("y"), var15.getInteger("z"), var15.getInteger("i"), var15.getInteger("t"));
				}
			}
		}
