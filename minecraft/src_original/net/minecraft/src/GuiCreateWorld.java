	...
	protected void actionPerformed(GuiButton var1) {
		if(var1.enabled) {
			if(var1.id == 1) {
				...
				this.mc.startWorld(this.folderName, this.textboxWorldName.getText(), new WorldSettings(var2, var9, this.field_35365_g, this.field_40232_h, EnumWorldType.values()[this.field_46030_z]));
				this.mc.displayGuiScreen((GuiScreen)null);
			} else if(var1.id == 3) {
