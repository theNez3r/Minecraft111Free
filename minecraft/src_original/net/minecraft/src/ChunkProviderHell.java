...
public class ChunkProviderHell implements IChunkProvider {
				...
				for(int var11 = 0; var11 < this.worldObj.worldHeight / 8; ++var11) {
					...
					for(int var30 = 0; var30 < 8; ++var30) {
						...
						for(int var41 = 0; var41 < 4; ++var41) {
							int var42 = var41 + var9 * 4 << this.worldObj.xShift | 0 + var10 * 4 << this.worldObj.heightShift | var11 * 8 + var30;
							int var43 = 1 << this.worldObj.heightShift;
							double var44 = 0.25D;
							double var46 = var33;
	...
	public void func_4058_b(int var1, int var2, byte[] var3) {
		...
		for(int var7 = 0; var7 < 16; ++var7) {
			for(int var8 = 0; var8 < 16; ++var8) {
				...
				for(int var15 = this.worldObj.worldMaxY; var15 >= 0; --var15) {
					int var16 = (var8 * 16 + var7) * this.worldObj.worldHeight + var15;
					if(var15 >= this.worldObj.worldMaxY - this.hellRNG.nextInt(5)) {
	...
	public List func_40377_a(EnumCreatureType var1, int var2, int var3, int var4) {
		if(var1 == EnumCreatureType.monster && this.genNetherBridge.func_40483_a(var2, var3, var4)) {
			return this.genNetherBridge.func_40485_b();
		} else {
