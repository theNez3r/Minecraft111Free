...
public abstract class J_JsonNode {
	...
	private Object wrapExceptionsFor(J_JsonNodeSelector var1, J_JsonNode var2, Object[] var3) {
		try {
			...
			throw J_JsonNodeDoesNotMatchPathElementsException.jsonNodeDoesNotMatchPathElementsException(var5, var3, J_JsonNodeFactories.aJsonArray(new J_JsonNode[]{var2}));
		}
	}
}
