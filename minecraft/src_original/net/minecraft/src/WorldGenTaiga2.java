	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		if(var4 >= 1 && var4 + var6 + 1 <= var1.worldHeight) {
			...
			for(var11 = var4; var11 <= var4 + 1 + var6 && var10; ++var11) {
				...
				for(var13 = var3 - var21; var13 <= var3 + var21 && var10; ++var13) {
					for(int var14 = var5 - var21; var14 <= var5 + var21 && var10; ++var14) {
						if(var11 >= 0 && var11 < var1.worldHeight) {
			...
			if(!var10) {
				...
				if((var11 == Block.grass.blockID || var11 == Block.dirt.blockID) && var4 < var1.worldHeight - var6 - 1) {
					...
					for(var16 = 0; var16 < var6 - var15; ++var16) {
						...
						if(var17 == 0 || var17 == Block.leaves.blockID) {
							this.func_41060_a(var1, var3, var4 + var16, var5, Block.wood.blockID, 1);
						}
					}
