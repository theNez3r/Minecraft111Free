...
public class ComponentStrongholdStairs extends ComponentStronghold {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		if(this.field_35327_a) {
			StructureStrongholdPieces.func_40541_a(ComponentStrongholdCrossing.class);
		}
	...
	public static ComponentStrongholdStairs getStrongholdStairsComponent(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		...
		return canStrongholdGoDeeper(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentStrongholdStairs(var6, var1, var7, var5) : null;
	}
