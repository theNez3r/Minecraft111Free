...
public class Potion {
	...
	public static final Potion digSpeed = (new Potion(3, false, 14270531)).setPotionName("potion.digSpeed").setIconIndex(2, 0).func_40591_a(1.5D);
	...
	public static final Potion confusion = (new Potion(9, true, 5578058)).setPotionName("potion.confusion").setIconIndex(3, 1).func_40591_a(0.25D);
	public static final Potion regeneration = (new Potion(10, false, 13458603)).setPotionName("potion.regeneration").setIconIndex(7, 0).func_40591_a(0.25D);
	...
	public static final Potion invisibility = (new Potion(14, false, 8356754)).setPotionName("potion.invisibility").setIconIndex(0, 1).func_40590_e();
	public static final Potion blindness = (new Potion(15, true, 2039587)).setPotionName("potion.blindness").setIconIndex(5, 1).func_40591_a(0.25D);
	public static final Potion nightVision = (new Potion(16, false, 2039713)).setPotionName("potion.nightVision").setIconIndex(4, 1).func_40590_e();
	...
	public static final Potion poison = (new Potion(19, true, 5149489)).setPotionName("potion.poison").setIconIndex(6, 0).func_40591_a(0.25D);
	...
	protected Potion(int var1, boolean var2, int var3) {
		...
		if(var2) {
			this.field_40598_L = 0.5D;
		} else {
			this.field_40598_L = 1.0D;
		}
	...
	protected Potion func_40591_a(double var1) {
		this.field_40598_L = var1;
		return this;
	}

	public double func_40592_d() {
		return this.field_40598_L;
	}

	public Potion func_40590_e() {
		this.field_40599_M = true;
		return this;
	}

	public boolean func_40593_f() {
		return this.field_40599_M;
	}
