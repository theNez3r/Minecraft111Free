...
public class ComponentVillageHouse2 extends ComponentVillage {
	...
	public static ComponentVillageHouse2 func_35376_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		...
		return canVillageGoDeeper(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentVillageHouse2(var6, var1, var7, var5) : null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		if(!this.field_46005_c) {
			...
			if(var3.isInBbVolume(var5, var4, var6)) {
				this.field_46005_c = true;
				this.createTreasureChestAtCurrentPosition(var1, var3, var2, 5, 1, 5, field_46006_a, 3 + var2.nextInt(6));
			}
		}
