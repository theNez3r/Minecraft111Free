...
public class EntityDragon extends EntityDragonBase {
	...
	public DragonPart[] dragonPartArray = new DragonPart[]{this.dragonPartHead = new DragonPart(this, "head", 6.0F, 6.0F), this.dragonPartBody = new DragonPart(this, "body", 8.0F, 8.0F), this.field_40156_i = new DragonPart(this, "tail", 4.0F, 4.0F), this.field_40153_j = new DragonPart(this, "tail", 4.0F, 4.0F), this.field_40154_k = new DragonPart(this, "tail", 4.0F, 4.0F), this.field_40151_l = new DragonPart(this, "wing", 4.0F, 4.0F), this.field_40152_m = new DragonPart(this, "wing", 4.0F, 4.0F)};
	...
	public double[] func_40139_a(int var1, float var2) {
		if(this.health <= 0) {
			var2 = 0.0F;
		}

		var2 = 1.0F - var2;
		int var3 = this.field_40145_e - var1 * 1 & 63;
		int var4 = this.field_40145_e - var1 * 1 - 1 & 63;
		...
		var5[2] = this.field_40144_d[var3][2] + (this.field_40144_d[var4][2] - this.field_40144_d[var3][2]) * (double)var2;
		return var5;
	}
	...
	public void onLivingUpdate() {
		...
		if(this.health <= 0) {
			...
			if(this.worldObj.singleplayerWorld) {
				...
				if(this.field_40157_t != null) {
					this.targetX = this.field_40157_t.posX;
					this.targetZ = this.field_40157_t.posZ;
					...
					this.targetY = this.field_40157_t.boundingBox.minY + var16;
				} else {
			...
			this.field_40156_i.width = this.field_40156_i.height = 2.0F;
			this.field_40153_j.width = this.field_40153_j.height = 2.0F;
			this.field_40154_k.width = this.field_40154_k.height = 2.0F;
			this.dragonPartBody.height = 3.0F;
			this.dragonPartBody.width = 5.0F;
			this.field_40151_l.height = 2.0F;
			this.field_40151_l.width = 4.0F;
			this.field_40152_m.height = 3.0F;
			this.field_40152_m.width = 4.0F;
			...
			this.field_40151_l.onUpdate();
			this.field_40151_l.setLocationAndAngles(this.posX + (double)(var7 * 4.5F), this.posY + 2.0D, this.posZ + (double)(var28 * 4.5F), 0.0F, 0.0F);
			this.field_40152_m.onUpdate();
			this.field_40152_m.setLocationAndAngles(this.posX - (double)(var7 * 4.5F), this.posY + 2.0D, this.posZ - (double)(var28 * 4.5F), 0.0F, 0.0F);
			if(!this.worldObj.singleplayerWorld) {
				this.func_41033_v();
			}

			if(!this.worldObj.singleplayerWorld && this.maxHurtTime == 0) {
				this.func_41034_a(this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.field_40151_l.boundingBox.expand(4.0D, 2.0D, 4.0D).offset(0.0D, -2.0D, 0.0D)));
				this.func_41034_a(this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.field_40152_m.boundingBox.expand(4.0D, 2.0D, 4.0D).offset(0.0D, -2.0D, 0.0D)));
				this.func_41035_b(this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.dragonPartHead.boundingBox.expand(1.0D, 1.0D, 1.0D)));
			}

			double[] var29 = this.func_40139_a(5, 1.0F);
			...
			for(int var30 = 0; var30 < 3; ++var30) {
				...
				if(var30 == 0) {
					var32 = this.field_40156_i;
				}

				if(var30 == 1) {
					var32 = this.field_40153_j;
				}

				if(var30 == 2) {
					var32 = this.field_40154_k;
				}

				double[] var34 = this.func_40139_a(12 + var30 * 2, 1.0F);
				float var35 = this.rotationYaw * (float)Math.PI / 180.0F + this.func_40141_a(var34[0] - var29[0]) * (float)Math.PI / 180.0F * 1.0F;
			...
			if(!this.worldObj.singleplayerWorld) {
				this.field_40159_q = this.func_40140_a(this.dragonPartHead.boundingBox) | this.func_40140_a(this.dragonPartBody.boundingBox);
			}
	...
	private void func_41034_a(List var1) {
	...
	private void func_41035_b(List var1) {
	...
	private void func_41037_w() {
		...
		if(this.rand.nextInt(2) == 0 && this.worldObj.playerEntities.size() > 0) {
			this.field_40157_t = (Entity)this.worldObj.playerEntities.get(this.rand.nextInt(this.worldObj.playerEntities.size()));
		} else {
			boolean var1 = false;
			...
			this.field_40157_t = null;
		}

	}

	private float func_40141_a(double var1) {
		while(var1 >= 180.0D) {
			var1 -= 360.0D;
		}
	...
	private boolean func_40140_a(AxisAlignedBB var1) {
	...
	protected void onDeathUpdate() {
		...
		int var4;
		int var5;
		if(!this.worldObj.singleplayerWorld && this.field_40158_r > 150 && this.field_40158_r % 5 == 0) {
			var4 = 1000;

			while(var4 > 0) {
				var5 = EntityXPOrb.getMore(var4);
				var4 -= var5;
		...
		if(this.field_40158_r == 200) {
			...
			this.func_41038_a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posZ));
			this.onEntityDeath();
			this.setEntityDead();
		}
	...
	private void func_41038_a(int var1, int var2) {
