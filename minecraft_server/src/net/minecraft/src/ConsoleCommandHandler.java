...
public class ConsoleCommandHandler {
	...
	public synchronized void handleCommand(ServerCommand var1) {
							...
							if(var2.toLowerCase().startsWith("kick ")) {
								...
								if(var2.toLowerCase().startsWith("tp ")) {
									...
									if(var2.toLowerCase().startsWith("give ")) {
										...
										var19 = var21[1];
										var18 = var5.getPlayerEntity(var19);
										if(var18 != null) {
											try {
												var20 = Integer.parseInt(var21[2]);
												if(Item.itemsList[var20] != null) {
													this.sendNoticeToOps(var4, "Giving " + var18.username + " some " + var20);
													int var10 = 1;
													int var11 = 0;
													if(var21.length > 3) {
													...
													var18.dropPlayerItem(new ItemStack(var20, var10, var11));
												} else {
													var3.log("There\'s no item with id " + var20);
												}
											} catch (NumberFormatException var14) {
												var3.log("There\'s no item with id " + var21[2]);
											}
										} else {
											var3.log("Can\'t find user " + var19);
										}
										...
										if(var18 != null) {
											try {
												var20 = Integer.parseInt(var21[2]);
												var20 = var20 > 5000 ? 5000 : var20;
												this.sendNoticeToOps(var4, "Giving " + var20 + " orbs to " + var18.username);
												var18.addExperience(var20);
										...
										if(var18 != null) {
											try {
												var20 = Integer.parseInt(var21[2]);
												var20 = WorldSettings.validGameType(var20);
												if(var18.itemInWorldManager.getGameType() != var20) {
													this.sendNoticeToOps(var4, "Setting " + var18.username + " to game mode " + var20);
													var18.itemInWorldManager.toggleGameType(var20);
													var18.playerNetServerHandler.sendPacket(new Packet70Bed(3, var20));
												} else {
													this.sendNoticeToOps(var4, var18.username + " already has game mode " + var20);
												}
										...
										try {
											...
											if("add".equalsIgnoreCase(var19)) {
												for(var20 = 0; var20 < this.minecraftServer.worldMngr.length; ++var20) {
													var22 = this.minecraftServer.worldMngr[var20];
	...
	private String func_40648_a(String[] var1, String var2) {
