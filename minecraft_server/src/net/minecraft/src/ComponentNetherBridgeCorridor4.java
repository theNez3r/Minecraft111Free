...
public class ComponentNetherBridgeCorridor4 extends ComponentNetherBridgePiece {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		...
		this.func_40285_b((ComponentNetherBridgeStartPiece)var1, var2, var3, 0, var4, var3.nextInt(8) > 0);
		this.func_40288_c((ComponentNetherBridgeStartPiece)var1, var2, var3, 0, var4, var3.nextInt(8) > 0);
	}

	public static ComponentNetherBridgeCorridor4 func_40298_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -3, 0, 0, 9, 7, 9, var5);
		return func_40286_a(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentNetherBridgeCorridor4(var6, var1, var7, var5) : null;
	}
