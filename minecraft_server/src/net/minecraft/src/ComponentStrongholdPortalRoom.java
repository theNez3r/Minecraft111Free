...
public class ComponentStrongholdPortalRoom extends ComponentStronghold {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		if(var1 != null) {
			((ComponentStrongholdStairs2)var1).field_40317_b = this;
		}

	}

	public static ComponentStrongholdPortalRoom func_40315_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -4, -1, 0, 11, 8, 16, var5);
		return canStrongholdGoDeeper(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentStrongholdPortalRoom(var6, var1, var7, var5) : null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		if(!this.field_40316_a) {
			...
			if(var3.isInBbVolume(var10, var13, var11)) {
