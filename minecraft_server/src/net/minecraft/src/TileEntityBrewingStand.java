...
public class TileEntityBrewingStand extends TileEntity implements IInventory {
			...
			if(!Item.itemsList[var1.itemID].isPotionIngredient()) {
				...
				for(int var3 = 0; var3 < 3; ++var3) {
					if(this.brewingItemStacks[var3] != null && this.brewingItemStacks[var3].itemID == Item.potion.shiftedIndex) {
						...
						int var5 = this.applyPotionIngredient(var4, var1);
						if(!ItemPotion.isSplash(var4) && ItemPotion.isSplash(var5)) {
							var2 = true;
							break;
						}

						List var6 = Item.potion.getPotionEffectsForDamage(var4);
						List var7 = Item.potion.getPotionEffectsForDamage(var5);
		...
		if(this.canBrew()) {
			...
			for(int var2 = 0; var2 < 3; ++var2) {
				if(this.brewingItemStacks[var2] != null && this.brewingItemStacks[var2].itemID == Item.potion.shiftedIndex) {
					...
					int var4 = this.applyPotionIngredient(var3, var1);
					List var5 = Item.potion.getPotionEffectsForDamage(var3);
					List var6 = Item.potion.getPotionEffectsForDamage(var4);
	...
	private int applyPotionIngredient(int var1, ItemStack var2) {
		return var2 == null ? var1 : (Item.itemsList[var2.itemID].isPotionIngredient() ? PotionHelper.applyIngredient(var1, Item.itemsList[var2.itemID].getPotionInfo()) : var1);
	}
