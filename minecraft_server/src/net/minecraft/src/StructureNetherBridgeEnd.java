...
public class StructureNetherBridgeEnd extends ComponentNetherBridgePiece {
	...
	public StructureNetherBridgeEnd(int var1, Random var2, StructureBoundingBox var3, int var4) {
		...
		this.field_40302_a = var2.nextInt();
	}

	public void buildComponent(StructureComponent var1, List var2, Random var3) {
	}

	public static StructureNetherBridgeEnd func_40301_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -1, -3, 0, 5, 10, 8, var5);
		return func_40286_a(var7) && StructureComponent.canFitInside(var0, var7) == null ? new StructureNetherBridgeEnd(var6, var1, var7, var5) : null;
	}

	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		Random var4 = new Random((long)this.field_40302_a);
