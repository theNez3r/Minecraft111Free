...
public class ItemDye extends Item {
	...
	public String getItemNameIS(ItemStack var1) {
		int var2 = MathHelper.func_41051_a(var1.getItemDamage(), 0, 15);
	...
	public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7) {
		if(!var2.canPlayerEdit(var4, var5, var6)) {
			...
			if(var8 == Block.sapling.blockID) {
				...
				if(!var3.singleplayerWorld && ((BlockMushroom)Block.blocksList[var8]).fertilizeMushroom(var3, var4, var5, var6, var3.rand)) {
					--var1.stackSize;
				}
