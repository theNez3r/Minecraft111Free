...
public class ComponentStrongholdLibrary extends ComponentStronghold {
	...
	public ComponentStrongholdLibrary(int var1, Random var2, StructureBoundingBox var3, int var4) {
		...
		this.field_35337_a = this.getRandomDoor(var2);
		this.boundingBox = var3;
		this.field_35336_c = var3.bbHeight() > 6;
	}
	...
	public static ComponentStrongholdLibrary func_35334_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if(!canStrongholdGoDeeper(var7) || StructureComponent.canFitInside(var0, var7) != null) {
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		if(this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			this.placeDoor(var1, var2, var3, this.field_35337_a, 4, 1, 0);
			...
			this.createTreasureChestAtCurrentPosition(var1, var3, var2, 3, 3, 5, field_35335_b, 1 + var2.nextInt(4));
			if(this.field_35336_c) {
