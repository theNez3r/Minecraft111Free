...
public class ComponentNetherBridgeCrossing extends ComponentNetherBridgePiece {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		this.func_40287_a((ComponentNetherBridgeStartPiece)var1, var2, var3, 2, 0, false);
		this.func_40285_b((ComponentNetherBridgeStartPiece)var1, var2, var3, 0, 2, false);
		this.func_40288_c((ComponentNetherBridgeStartPiece)var1, var2, var3, 0, 2, false);
	}

	public static ComponentNetherBridgeCrossing func_40306_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -2, 0, 0, 7, 9, 7, var5);
		return func_40286_a(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentNetherBridgeCrossing(var6, var1, var7, var5) : null;
	}
