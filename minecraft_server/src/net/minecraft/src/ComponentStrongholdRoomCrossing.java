...
public class ComponentStrongholdRoomCrossing extends ComponentStronghold {
	...
	public ComponentStrongholdRoomCrossing(int var1, Random var2, StructureBoundingBox var3, int var4) {
		...
		this.field_35349_a = this.getRandomDoor(var2);
	...
	public static ComponentStrongholdRoomCrossing func_35346_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		...
		return canStrongholdGoDeeper(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentStrongholdRoomCrossing(var6, var1, var7, var5) : null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		if(this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			this.placeDoor(var1, var2, var3, this.field_35349_a, 4, 1, 0);
			...
			case 2:
				...
				this.createTreasureChestAtCurrentPosition(var1, var3, var2, 3, 4, 8, field_35348_c, 1 + var2.nextInt(4));
			}
