...
public abstract class StructureStart {
	...
	public void generateStructure(World var1, Random var2, StructureBoundingBox var3) {
		...
		while(var4.hasNext()) {
			...
			if(var5.getStructureBoundingBox().canFitInside(var3) && !var5.addComponentParts(var1, var2, var3)) {
				var4.remove();
			}
		}
	...
	protected void updateBoundingBox() {
		...
		while(var1.hasNext()) {
			...
			this.boundingBox.expandTo(var2.getStructureBoundingBox());
		}

	}

	protected void markAvailableHeight(World var1, Random var2, int var3) {
		int var4 = var1.worldOceanHeight - var3;
		int var5 = this.boundingBox.bbHeight() + 1;
		if(var5 < var4) {
		...
		while(var7.hasNext()) {
			...
			var8.getStructureBoundingBox().offset(0, var6, 0);
		}

	}

	protected void func_40209_a(World var1, Random var2, int var3, int var4) {
		int var5 = var4 - var3 + 1 - this.boundingBox.bbHeight();
		boolean var6 = true;
		int var10;
		if(var5 > 1) {
		...
		while(var8.hasNext()) {
			...
			var9.getStructureBoundingBox().offset(0, var7, 0);
		}
