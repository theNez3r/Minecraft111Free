...
public class ComponentStrongholdCorridor extends ComponentStronghold {
	...
	public ComponentStrongholdCorridor(int var1, Random var2, StructureBoundingBox var3, int var4) {
		...
		this.field_35343_a = var4 != 2 && var4 != 0 ? var3.bbWidth() : var3.bbDepth();
	}
	...
	public static StructureBoundingBox func_35342_a(List var0, Random var1, int var2, int var3, int var4, int var5) {
		...
		StructureComponent var8 = StructureComponent.canFitInside(var0, var7);
		if(var8 == null) {
			return null;
		} else {
			if(var8.getStructureBoundingBox().minY == var7.minY) {
				for(int var9 = 3; var9 >= 1; --var9) {
					var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -1, -1, 0, 5, 5, var9 - 1, var5);
					if(!var8.getStructureBoundingBox().canFitInside(var7)) {
