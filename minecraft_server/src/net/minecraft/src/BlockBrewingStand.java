...
public class BlockBrewingStand extends BlockContainer {
	private Random field_40180_a = new Random();
	...
	public void onBlockRemoval(World var1, int var2, int var3, int var4) {
		...
		if(var5 != null && var5 instanceof TileEntityBrewingStand) {
			...
			for(int var7 = 0; var7 < var6.getSizeInventory(); ++var7) {
				...
				if(var8 != null) {
					float var9 = this.field_40180_a.nextFloat() * 0.8F + 0.1F;
					float var10 = this.field_40180_a.nextFloat() * 0.8F + 0.1F;
					float var11 = this.field_40180_a.nextFloat() * 0.8F + 0.1F;

					while(var8.stackSize > 0) {
						int var12 = this.field_40180_a.nextInt(21) + 10;
						...
						float var14 = 0.05F;
						var13.motionX = (double)((float)this.field_40180_a.nextGaussian() * var14);
						var13.motionY = (double)((float)this.field_40180_a.nextGaussian() * var14 + 0.2F);
						var13.motionZ = (double)((float)this.field_40180_a.nextGaussian() * var14);
