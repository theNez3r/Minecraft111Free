...
public class WorldManager implements IWorldAccess {
	...
	public void obtainEntitySkin(Entity var1) {
		this.mcServer.getEntityTracker(this.world.worldProvider.worldType).trackEntity(var1);
	}

	public void releaseEntitySkin(Entity var1) {
		this.mcServer.getEntityTracker(this.world.worldProvider.worldType).untrackEntity(var1);
	}
	...
	public void markBlockNeedsUpdate(int var1, int var2, int var3) {
		this.mcServer.configManager.markBlockNeedsUpdate(var1, var2, var3, this.world.worldProvider.worldType);
	}
	...
	public void playAuxSFX(EntityPlayer var1, int var2, int var3, int var4, int var5, int var6) {
		this.mcServer.configManager.func_28171_a(var1, (double)var3, (double)var4, (double)var5, 64.0D, this.world.worldProvider.worldType, new Packet61DoorChange(var2, var3, var4, var5, var6));
	}
}
