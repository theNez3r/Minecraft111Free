...
public abstract class MapGenStructure extends MapGenBase {
	...
	public boolean generateStructuresInChunk(World var1, Random var2, int var3, int var4) {
		...
		while(var8.hasNext()) {
			...
			if(var9.isSizeableStructure() && var9.getBoundingBox().isInBbArea(var5, var6, var5 + 15, var6 + 15)) {
	...
	public boolean func_40204_a(int var1, int var2, int var3) {
		...
		while(true) {
			...
			} while(!var5.getBoundingBox().isInBbArea(var1, var3, var1, var3));

			Iterator var6 = var5.func_40208_c().iterator();

			while(var6.hasNext()) {
				StructureComponent var7 = (StructureComponent)var6.next();
				if(var7.getStructureBoundingBox().isInBbVolume(var1, var2, var3)) {
					return true;
				}
			}
		}
	...
	public ChunkPosition func_40202_a(World var1, int var2, int var3, int var4) {
		this.worldObj = var1;
		this.rand.setSeed(var1.getRandomSeed());
		long var5 = this.rand.nextLong();
		long var7 = this.rand.nextLong();
		long var9 = (long)(var2 >> 4) * var5;
		long var11 = (long)(var4 >> 4) * var7;
		this.rand.setSeed(var9 ^ var11 ^ var1.getRandomSeed());
		...
		while(var16.hasNext()) {
			...
			if(var17.isSizeableStructure()) {
				StructureComponent var18 = (StructureComponent)var17.func_40208_c().get(0);
				var19 = var18.func_40281_b_();
				var20 = var19.x - var2;
				var21 = var19.y - var3;
				var22 = var19.z - var4;
