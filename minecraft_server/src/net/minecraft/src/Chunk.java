...
public class Chunk {
	...
	public Chunk(World var1, byte[] var2, int var3, int var4) {
		this(var1, var3, var4);
		this.blocks = var2;
		this.data = new NibbleArray(var2.length, var1.worldYBits);
		this.skylightMap = new NibbleArray(var2.length, var1.worldYBits);
		this.blocklightMap = new NibbleArray(var2.length, var1.worldYBits);
	}
	...
	public void generateSkylightMap() {
		...
		for(var2 = 0; var2 < 16; ++var2) {
			for(var3 = 0; var3 < 16; ++var3) {
				...
				int var5;
				for(var5 = var2 << this.worldObj.xShift | var3 << this.worldObj.worldYBits; var4 > 0 && Block.lightOpacity[this.blocks[var5 + var4 - 1] & 255] == 0; --var4) {
				}
	...
	private void relightBlock(int var1, int var2, int var3) {
		...
		for(int var6 = var1 << this.worldObj.xShift | var3 << this.worldObj.worldYBits; var5 > 0 && Block.lightOpacity[this.blocks[var6 + var5 - 1] & 255] == 0; --var5) {
		}
	...
	public int getBlockID(int var1, int var2, int var3) {
		return this.blocks[var1 << this.worldObj.xShift | var3 << this.worldObj.worldYBits | var2] & 255;
	}
	...
	public boolean setBlockIDWithMetadata(int var1, int var2, int var3, int var4, int var5) {
		...
		int var9 = this.blocks[var1 << this.worldObj.xShift | var3 << this.worldObj.worldYBits | var2] & 255;
		if(var9 == var4 && this.data.getNibble(var1, var2, var3) == var5) {
			return false;
		} else {
			int var10 = this.xPosition * 16 + var1;
			int var11 = this.zPosition * 16 + var3;
			this.blocks[var1 << this.worldObj.xShift | var3 << this.worldObj.worldYBits | var2] = (byte)(var6 & 255);
			if(var9 != 0) {
	...
	public boolean setBlockID(int var1, int var2, int var3, int var4) {
		...
		int var8 = this.blocks[var1 << this.worldObj.xShift | var3 << this.worldObj.worldYBits | var2] & 255;
		if(var8 == var4) {
			return false;
		} else {
			int var9 = this.xPosition * 16 + var1;
			int var10 = this.zPosition * 16 + var3;
			this.blocks[var1 << this.worldObj.xShift | var3 << this.worldObj.worldYBits | var2] = (byte)(var5 & 255);
			if(var8 != 0) {
		...
		if(var9 * var10 * var11 == this.blocks.length) {
			...
			for(var12 = var2; var12 < var5; ++var12) {
				for(var13 = var4; var13 < var7; ++var13) {
					var14 = var12 << this.worldObj.xShift | var13 << this.worldObj.worldYBits | var3;
					var15 = var6 - var3;
			...
			for(var12 = var2; var12 < var5; ++var12) {
				for(var13 = var4; var13 < var7; ++var13) {
					var14 = (var12 << this.worldObj.xShift | var13 << this.worldObj.worldYBits | var3) >> 1;
					var15 = (var6 - var3) / 2;
