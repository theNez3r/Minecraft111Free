...
public class StructureStrongholdPieces {
	...
	private static ComponentStronghold getStrongholdComponentFromWeightedPiece(Class var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7) {
		...
		if(var0 == ComponentStrongholdStraight.class) {
			var8 = ComponentStrongholdStraight.func_35338_a(var1, var2, var3, var4, var5, var6, var7);
		} else if(var0 == ComponentStrongholdPrison.class) {
			var8 = ComponentStrongholdPrison.func_35332_a(var1, var2, var3, var4, var5, var6, var7);
		} else if(var0 == ComponentStrongholdLeftTurn.class) {
			var8 = ComponentStrongholdLeftTurn.func_35330_a(var1, var2, var3, var4, var5, var6, var7);
		} else if(var0 == ComponentStrongholdRightTurn.class) {
			var8 = ComponentStrongholdRightTurn.func_35330_a(var1, var2, var3, var4, var5, var6, var7);
		} else if(var0 == ComponentStrongholdRoomCrossing.class) {
			var8 = ComponentStrongholdRoomCrossing.func_35346_a(var1, var2, var3, var4, var5, var6, var7);
		} else if(var0 == ComponentStrongholdStairsStraight.class) {
			var8 = ComponentStrongholdStairsStraight.func_35344_a(var1, var2, var3, var4, var5, var6, var7);
			...
			var8 = ComponentStrongholdCrossing.func_35350_a(var1, var2, var3, var4, var5, var6, var7);
		} else if(var0 == ComponentStrongholdChestCorridor.class) {
			var8 = ComponentStrongholdChestCorridor.func_40311_a(var1, var2, var3, var4, var5, var6, var7);
		} else if(var0 == ComponentStrongholdLibrary.class) {
			var8 = ComponentStrongholdLibrary.func_35334_a(var1, var2, var3, var4, var5, var6, var7);
		} else if(var0 == ComponentStrongholdPortalRoom.class) {
			var8 = ComponentStrongholdPortalRoom.func_40315_a(var1, var2, var3, var4, var5, var6, var7);
		}
	...
	private static StructureComponent func_35621_c(ComponentStrongholdStairs2 var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7) {
		if(var7 > 50) {
			return null;
		} else if(Math.abs(var3 - var0.getStructureBoundingBox().minX) <= 112 && Math.abs(var5 - var0.getStructureBoundingBox().minZ) <= 112) {
	...
	static Class func_40541_a(Class var0) {
		field_40542_d = var0;
		return var0;
	}
