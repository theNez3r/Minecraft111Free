...
public class SaveConverterMcRegion extends SaveFormatOld {
	...
	public boolean convertMapFormat(String var1, IProgressUpdate var2) {
		...
		this.func_22108_a(var9, var3, var4);
		if(var10.exists()) {
			this.func_22108_a(var10, var5, var6);
		}

		if(var11.exists()) {
			this.func_22108_a(var11, var7, var8);
		}

		int var12 = var3.size() + var5.size() + var7.size() + var4.size() + var6.size() + var8.size();
		System.out.println("Total conversion count is " + var12);
		this.func_22107_a(var9, var3, 0, var12, var2);
		this.func_22107_a(var10, var5, var3.size(), var12, var2);
		this.func_22107_a(var11, var7, var3.size() + var5.size(), var12, var2);
		...
		this.func_22109_a(var4, var3.size() + var5.size(), var12, var2);
		if(var10.exists()) {
			this.func_22109_a(var6, var3.size() + var5.size() + var4.size(), var12, var2);
		}
