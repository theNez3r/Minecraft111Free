...
public abstract class EntityPlayer extends EntityLiving {
	...
	public boolean isBlocking() {
		return this.isUsingItem() && Item.itemsList[this.itemInUse.itemID].getAction(this.itemInUse) == EnumAction.block;
	}
	...
	public void onUpdate() {
		if(this.itemInUse != null) {
			...
			if(var1 != this.itemInUse) {
				...
				if(--this.itemInUseCount == 0 && !this.worldObj.singleplayerWorld) {
					this.func_35199_C();
				}
			}
		}
	...
	public boolean canEat(boolean var1) {
		return (var1 || this.foodStats.mustEat()) && !this.capabilities.disableDamage;
	}
