...
public class Packet9Respawn extends Packet {
	...
	public Packet9Respawn(byte var1, byte var2, long var3, EnumWorldType var5, int var6, int var7) {
		...
		this.difficultySetting = var2;
		this.mapSeed = var3;
		this.worldHeight = var6;
		this.creativeMode = var7;
		this.field_46002_f = var5;
	}
	...
	public void readPacketData(DataInputStream var1) throws IOException {
		...
		this.field_46002_f = EnumWorldType.func_46049_a(var2);
		if(this.field_46002_f == null) {
			this.field_46002_f = EnumWorldType.DEFAULT;
		}
	...
	public void writePacketData(DataOutputStream var1) throws IOException {
		...
		writeString(this.field_46002_f.name(), var1);
	}

	public int getPacketSize() {
		return 13 + this.field_46002_f.name().length();
	}
}
