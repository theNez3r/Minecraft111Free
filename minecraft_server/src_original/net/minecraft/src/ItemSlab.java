		...
		if(var1.stackSize == 0) {
			...
			if(var7 == 1 && var8 == Block.stairSingle.blockID && var9 == var1.getItemDamage()) {
				if(var3.setBlockAndMetadataWithNotify(var4, var5, var6, Block.stairDouble.blockID, var9)) {
					var3.playSoundEffect((double)((float)var4 + 0.5F), (double)((float)var5 + 0.5F), (double)((float)var6 + 0.5F), Block.stairDouble.stepSound.stepSoundDir(), (Block.stairDouble.stepSound.getVolume() + 1.0F) / 2.0F, Block.stairDouble.stepSound.getPitch() * 0.8F);
					--var1.stackSize;
				}
