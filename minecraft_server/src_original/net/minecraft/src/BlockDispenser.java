...
public class BlockDispenser extends BlockContainer {
		...
		if(var11 != null) {
			...
			if(var12 == null) {
				...
				if(var12.itemID == Item.arrow.shiftedIndex) {
					EntityArrow var25 = new EntityArrow(var1, var13, var15, var17);
					var25.setArrowHeading((double)var9, (double)0.1F, (double)var10, 1.1F, 6.0F);
					var25.doesArrowBelongToPlayer = true;
					var1.spawnEntityInWorld(var25);
					var1.playAuxSFX(1002, var2, var3, var4, 0);
				} else if(var12.itemID == Item.egg.shiftedIndex) {
					EntityEgg var24 = new EntityEgg(var1, var13, var15, var17);
					var24.setThrowableHeading((double)var9, (double)0.1F, (double)var10, 1.1F, 6.0F);
					...
					var23.setThrowableHeading((double)var9, (double)0.1F, (double)var10, 1.1F, 6.0F);
					var1.spawnEntityInWorld(var23);
					var1.playAuxSFX(1002, var2, var3, var4, 0);
				} else if(var12.itemID == Item.potion.shiftedIndex && ItemPotion.isSplash(var12.getItemDamage())) {
					EntityPotion var22 = new EntityPotion(var1, var13, var15, var17, var12.getItemDamage());
					var22.setThrowableHeading((double)var9, (double)0.1F, (double)var10, 1.375F, 3.0F);
					var1.spawnEntityInWorld(var22);
					var1.playAuxSFX(1002, var2, var3, var4, 0);
				} else {
					EntityItem var19 = new EntityItem(var1, var13, var15 - 0.3D, var17, var12);
					double var20 = var5.nextDouble() * 0.1D + 0.2D;
					var19.motionX = (double)var9 * var20;
					var19.motionY = (double)0.2F;
					var19.motionZ = (double)var10 * var20;
					var19.motionX += var5.nextGaussian() * (double)0.0075F * 6.0D;
					var19.motionY += var5.nextGaussian() * (double)0.0075F * 6.0D;
					var19.motionZ += var5.nextGaussian() * (double)0.0075F * 6.0D;
	...
	public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
		if(!var1.singleplayerWorld && (var1.isBlockIndirectlyGettingPowered(var2, var3, var4) || var1.isBlockIndirectlyGettingPowered(var2, var3 + 1, var4))) {
