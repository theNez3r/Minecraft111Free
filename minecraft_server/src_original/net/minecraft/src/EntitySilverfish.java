...
public class EntitySilverfish extends EntityMob {
	...
	protected void func_41011_a(int var1, int var2, int var3, int var4) {
		...
		if(!this.worldObj.singleplayerWorld) {
			...
			if(this.entityToAttack == null && !this.hasPath()) {
				...
				if(BlockSilverfish.getPosingIdByMetadata(var5)) {
					this.worldObj.setBlockAndMetadataWithNotify(var1 + Facing.offsetsXForSide[var9], var2 + Facing.offsetsYForSide[var9], var3 + Facing.offsetsZForSide[var9], Block.silverfish.blockID, BlockSilverfish.func_35061_d(var5));
