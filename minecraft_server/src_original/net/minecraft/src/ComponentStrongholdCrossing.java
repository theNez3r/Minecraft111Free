...
public class ComponentStrongholdCrossing extends ComponentStronghold {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		...
		if(this.field_35353_b) {
			this.func_35321_b((ComponentStrongholdStairs2)var1, var2, var3, var4, 1);
		}

		if(this.field_35354_c) {
			this.func_35321_b((ComponentStrongholdStairs2)var1, var2, var3, var5, 7);
		}

		if(this.field_35351_d) {
			this.func_35320_c((ComponentStrongholdStairs2)var1, var2, var3, var4, 1);
		}

		if(this.field_35352_e) {
			this.func_35320_c((ComponentStrongholdStairs2)var1, var2, var3, var5, 7);
		}
	...
	public static ComponentStrongholdCrossing func_35350_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		...
		return canStrongholdGoDeeper(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentStrongholdCrossing(var6, var1, var7, var5) : null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		if(this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			this.placeDoor(var1, var2, var3, this.field_35355_a, 4, 3, 0);
			if(this.field_35353_b) {
