...
public class MapGenStronghold extends MapGenStructure {
	private BiomeGenBase[] allowedBiomeGenBases = new BiomeGenBase[]{BiomeGenBase.desert, BiomeGenBase.forest, BiomeGenBase.extremeHills, BiomeGenBase.swampland, BiomeGenBase.taiga, BiomeGenBase.icePlains, BiomeGenBase.iceMountains, BiomeGenBase.field_46083_s, BiomeGenBase.field_46082_t, BiomeGenBase.field_46080_v};
	...
	protected boolean canSpawnStructureAtCoords(int var1, int var2) {
		if(!this.ranBiomeCheck) {
			...
			var3.setSeed(this.worldObj.getRandomSeed());
			...
			for(int var6 = 0; var6 < this.structureCoords.length; ++var6) {
				...
				ChunkPosition var19 = this.worldObj.getWorldChunkManager().func_35139_a((var9 << 4) + 8, (var10 << 4) + 8, 112, var11, var3);
				if(var19 != null) {
					var9 = var19.x >> 4;
					var10 = var19.z >> 4;
				} else {
	...
	protected StructureStart getStructureStart(int var1, int var2) {
		...
		for(var3 = new StructureStrongholdStart(this.worldObj, this.rand, var1, var2); var3.func_40208_c().isEmpty() || ((ComponentStrongholdStairs2)var3.func_40208_c().get(0)).field_40317_b == null; var3 = new StructureStrongholdStart(this.worldObj, this.rand, var1, var2)) {
		}
