	...
	public static List buildEnchantmentList(Random var0, ItemStack var1, int var2) {
		...
		if(var4 <= 0) {
			...
			if(var9 != null && !var9.isEmpty()) {
				EnchantmentData var10 = (EnchantmentData)WeightedRandom.func_35689_a(var0, var9.values());
				if(var10 != null) {
					var8 = new ArrayList();
					var8.add(var10);
					...
					for(int var11 = var7 >> 1; var0.nextInt(50) <= var11; var11 >>= 1) {
						...
						if(!var9.isEmpty()) {
							EnchantmentData var17 = (EnchantmentData)WeightedRandom.func_35689_a(var0, var9.values());
							var8.add(var17);
						}
					}
				}
