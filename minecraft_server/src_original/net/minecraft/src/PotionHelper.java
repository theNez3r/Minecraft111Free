...
public class PotionHelper {
	...
	private static final HashMap field_40565_l = new HashMap();
	...
	public static int func_40553_a(Collection var0) {
		int var1 = 3694022;
	...
	private static int func_40546_a(boolean var0, boolean var1, boolean var2, int var3, int var4, int var5, int var6) {
		int var7 = 0;
		if(var0) {
	...
	private static int func_40554_a(String var0, int var1, int var2, int var3) {
		if(var1 < var0.length() && var2 >= 0 && var1 < var2) {
			int var4 = var0.indexOf(124, var1);
			int var5;
			int var17;
			if(var4 >= 0 && var4 < var2) {
				var5 = func_40554_a(var0, var1, var4 - 1, var3);
				if(var5 > 0) {
					return var5;
				} else {
					var17 = func_40554_a(var0, var4 + 1, var2, var3);
					return var17 > 0 ? var17 : 0;
				}
			} else {
				var5 = var0.indexOf(38, var1);
				if(var5 >= 0 && var5 < var2) {
					var17 = func_40554_a(var0, var1, var5 - 1, var3);
					if(var17 <= 0) {
						return 0;
					} else {
						int var18 = func_40554_a(var0, var5 + 1, var2, var3);
					...
					for(int var15 = var1; var15 < var2; ++var15) {
						...
						if(var16 >= 48 && var16 <= 57) {
							...
							if(var8) {
								var14 += func_40546_a(var9, var7, var10, var11, var12, var13, var3);
								var9 = false;
								var10 = var9;
								var6 = var9;
								var7 = var9;
	...
	public static List getPotionEffects(int var0, boolean var1) {
		...
		for(int var5 = 0; var5 < var4; ++var5) {
			...
			if(var6 != null && (!var6.func_40593_f() || var1)) {
				String var7 = (String)field_40565_l.get(Integer.valueOf(var6.getId()));
				if(var7 != null) {
					int var8 = func_40554_a(var7, 0, var7.length(), var0);
					if(var8 > 0) {
						int var9 = 0;
						String var10 = (String)field_40566_m.get(Integer.valueOf(var6.getId()));
						if(var10 != null) {
							var9 = func_40554_a(var10, 0, var10.length(), var0);
							if(var9 < 0) {
								var9 = 0;
							}
						}
						...
						if(var6.isInstant()) {
							...
							var8 >>= var9;
							var8 = (int)Math.round((double)var8 * var6.func_40592_d());
							if((var0 & 16384) != 0) {
	...
	private static int handleBitFromIngredient(int var0, int var1, boolean var2, boolean var3, boolean var4) {
		if(var4) {
	...
	public static int applyIngredient(int var0, String var1) {
		...
		for(int var9 = var2; var9 < var3; ++var9) {
			...
			if(var10 >= 48 && var10 <= 57) {
				...
				if(var4) {
					var0 = handleBitFromIngredient(var0, var8, var6, var5, var7);
					var7 = false;
					var6 = var7;
					var4 = var7;
					var8 = 0;
