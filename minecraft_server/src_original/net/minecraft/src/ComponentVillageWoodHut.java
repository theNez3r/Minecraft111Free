...
public class ComponentVillageWoodHut extends ComponentVillage {
	...
	public static ComponentVillageWoodHut func_35393_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		...
		return canVillageGoDeeper(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentVillageWoodHut(var6, var1, var7, var5) : null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		if(this.field_35395_c > 0) {
			this.placeBlockAtCurrentPosition(var1, Block.fence.blockID, 0, this.field_35395_c, 1, 3, var3);
			this.placeBlockAtCurrentPosition(var1, Block.pressurePlatePlanks.blockID, 0, this.field_35395_c, 2, 3, var3);
		}
