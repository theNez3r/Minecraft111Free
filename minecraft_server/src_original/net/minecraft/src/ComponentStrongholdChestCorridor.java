...
public class ComponentStrongholdChestCorridor extends ComponentStronghold {
	...
	public ComponentStrongholdChestCorridor(int var1, Random var2, StructureBoundingBox var3, int var4) {
		...
		this.field_40312_b = this.getRandomDoor(var2);
	...
	public static ComponentStrongholdChestCorridor func_40311_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -1, -1, 0, 5, 5, 7, var5);
		return canStrongholdGoDeeper(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentStrongholdChestCorridor(var6, var1, var7, var5) : null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		if(this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			this.placeDoor(var1, var2, var3, this.field_40312_b, 1, 1, 0);
			...
			if(!this.field_40313_c) {
				var4 = this.getYWithOffset(2);
				int var5 = this.getXWithOffset(3, 3);
				int var6 = this.getZWithOffset(3, 3);
				if(var3.isInBbVolume(var5, var4, var6)) {
					this.field_40313_c = true;
					this.createTreasureChestAtCurrentPosition(var1, var3, var2, 3, 2, 3, field_40314_a, 2 + var2.nextInt(2));
				}
			}
