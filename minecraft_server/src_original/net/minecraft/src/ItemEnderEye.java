...
public class ItemEnderEye extends Item {
	...
	public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7) {
		...
		if(var2.canPlayerEdit(var4, var5, var6) && var8 == Block.endPortalFrame.blockID && !BlockEndPortalFrame.isEnderEyeInserted(var9)) {
			if(var3.singleplayerWorld) {
				...
				boolean var24 = false;
				boolean var14 = true;
				int var25 = Direction.field_35607_f[var10];
				...
				for(var16 = -2; var16 <= 2; ++var16) {
					var26 = var4 + Direction.field_35612_a[var25] * var16;
					var18 = var6 + Direction.field_35610_b[var25] * var16;
				...
				if(var14 && var12 == var23 + 2) {
					for(var16 = var23; var16 <= var12; ++var16) {
						var26 = var4 + Direction.field_35612_a[var25] * var16;
						var18 = var6 + Direction.field_35610_b[var25] * var16;
						var26 += Direction.field_35612_a[var10] * 4;
						var18 += Direction.field_35610_b[var10] * 4;
						var27 = var3.getBlockId(var26, var5, var18);
						var20 = var3.getBlockMetadata(var26, var5, var18);
					...
					for(var16 = var23 - 1; var16 <= var12 + 1; var16 += 4) {
						for(var26 = 1; var26 <= 3; ++var26) {
							var18 = var4 + Direction.field_35612_a[var25] * var16;
							var27 = var6 + Direction.field_35610_b[var25] * var16;
							var18 += Direction.field_35612_a[var10] * var26;
							var27 += Direction.field_35610_b[var10] * var26;
	...
	public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3) {
		MovingObjectPosition var4 = this.func_40225_a(var2, var3, false);
		...
		if(!var2.singleplayerWorld) {
			ChunkPosition var7 = var2.func_40214_b("Stronghold", (int)var3.posX, (int)var3.posY, (int)var3.posZ);
			if(var7 != null) {
