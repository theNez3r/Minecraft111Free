...
public class ComponentNetherBridgeStraight extends ComponentNetherBridgePiece {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		this.func_40287_a((ComponentNetherBridgeStartPiece)var1, var2, var3, 1, 3, false);
	}

	public static ComponentNetherBridgeStraight func_40289_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -1, -3, 0, 5, 10, 19, var5);
		return func_40286_a(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentNetherBridgeStraight(var6, var1, var7, var5) : null;
	}
