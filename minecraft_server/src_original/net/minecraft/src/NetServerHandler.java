...
public class NetServerHandler extends NetHandler implements ICommandListener {
	...
	public void handleFlying(Packet10Flying var1) {
		...
		if(!this.playerEntity.field_41032_j) {
			double var3;
			if(!this.hasMoved) {
			...
			if(this.hasMoved) {
				...
				boolean var25 = false;
				if(var19 > 1.0D / 16.0D && !this.playerEntity.isPlayerSleeping() && !this.playerEntity.itemInWorldManager.isCreative()) {
					var25 = true;
	...
	public void handlePlace(Packet15Place var1) {
		...
		boolean var4 = var2.disableSpawnProtection = var2.worldProvider.worldType != 0 || this.mcServer.configManager.isOp(this.playerEntity.username);
		if(var1.direction == 255) {
			...
			int var10 = MathHelper.abs(var5 - var9.posX);
			int var11 = MathHelper.abs(var7 - var9.posZ);
			if(var10 > var11) {
				var11 = var10;
			}
	...
	public void handleChat(Packet3Chat var1) {
		...
		if(var2.length() > 100) {
			...
			for(int var3 = 0; var3 < var2.length(); ++var3) {
				if(ChatAllowedCharacters.allowedCharacters.indexOf(var2.charAt(var3)) < 0 && var2.charAt(var3) < 32) {
	...
	public void handleRespawn(Packet9Respawn var1) {
		if(this.playerEntity.field_41032_j) {
			...
			if(this.playerEntity.getEntityHealth() > 0) {
				return;
			}
	...
	public void handleEnchantItem(Packet108EnchantItem var1) {
		if(this.playerEntity.currentCraftingInventory.windowId == var1.windowId && this.playerEntity.currentCraftingInventory.getCanCraft(this.playerEntity)) {
			this.playerEntity.currentCraftingInventory.enchantItem(this.playerEntity, var1.enchantment);
			this.playerEntity.currentCraftingInventory.updateCraftingResults();
		}
	...
	public void handleCreativeSetSlot(Packet107CreativeSetSlot var1) {
		if(this.playerEntity.itemInWorldManager.isCreative()) {
			...
			boolean var4 = var1.slot >= 36 && var1.slot < 36 + InventoryPlayer.func_25054_e();
			...
			if(var4 && var5 && var6) {
				if(var3 == null) {
					this.playerEntity.personalCraftingInventory.putStackInSlot(var1.slot, (ItemStack)null);
				} else {
					this.playerEntity.personalCraftingInventory.putStackInSlot(var1.slot, var3);
				}

				this.playerEntity.personalCraftingInventory.setCanCraft(this.playerEntity, true);
			} else if(var2 && var5 && var6) {
				this.playerEntity.dropPlayerItem(var3);
			}
		}
	...
	public void handleKeepAlive(Packet0KeepAlive var1) {
		if(var1.randomId == this.field_35013_i) {
