...
public class ComponentNetherBridgeNetherStalkRoom extends ComponentNetherBridgePiece {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		this.func_40287_a((ComponentNetherBridgeStartPiece)var1, var2, var3, 5, 3, true);
		this.func_40287_a((ComponentNetherBridgeStartPiece)var1, var2, var3, 5, 11, true);
	}

	public static ComponentNetherBridgeNetherStalkRoom func_40291_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -5, -3, 0, 13, 14, 13, var5);
		return func_40286_a(var7) && StructureComponent.canFitInside(var0, var7) == null ? new ComponentNetherBridgeNetherStalkRoom(var6, var1, var7, var5) : null;
	}
