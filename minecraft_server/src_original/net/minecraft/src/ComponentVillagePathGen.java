...
public class ComponentVillagePathGen extends ComponentVillageRoadPiece {
	...
	public ComponentVillagePathGen(int var1, Random var2, StructureBoundingBox var3, int var4) {
		...
		this.averageGroundLevel = Math.max(var3.bbWidth(), var3.bbDepth());
	}
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		...
		for(var5 = var3.nextInt(5); var5 < this.averageGroundLevel - 8; var5 += 2 + var3.nextInt(5)) {
			...
			if(var6 != null) {
				var5 += Math.max(var6.boundingBox.bbWidth(), var6.boundingBox.bbDepth());
				var4 = true;
			}
		}
	...
	public static StructureBoundingBox func_35378_a(ComponentVillageStartPiece var0, List var1, Random var2, int var3, int var4, int var5, int var6) {
		for(int var7 = 7 * MathHelper.getRandomIntegerInRange(var2, 3, 5); var7 >= 7; var7 -= 7) {
			...
			if(StructureComponent.canFitInside(var1, var8) == null) {
				return var8;
			}
		}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		for(int var4 = this.boundingBox.minX; var4 <= this.boundingBox.maxX; ++var4) {
			for(int var5 = this.boundingBox.minZ; var5 <= this.boundingBox.maxZ; ++var5) {
				if(var3.isInBbVolume(var4, 64, var5)) {
