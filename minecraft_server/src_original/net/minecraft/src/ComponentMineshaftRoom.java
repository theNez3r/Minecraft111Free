...
public class ComponentMineshaftRoom extends StructureComponent {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		...
		int var6 = this.boundingBox.bbHeight() - 3 - 1;
		if(var6 <= 0) {
			var6 = 1;
		}
		...
		for(var5 = 0; var5 < this.boundingBox.bbWidth(); var5 += 4) {
			var5 += var3.nextInt(this.boundingBox.bbWidth());
			if(var5 + 3 > this.boundingBox.bbWidth()) {
				break;
			}
			...
			if(var7 != null) {
				var8 = var7.getStructureBoundingBox();
				this.field_35356_a.add(new StructureBoundingBox(var8.minX, var8.minY, this.boundingBox.minZ, var8.maxX, var8.maxY, this.boundingBox.minZ + 1));
			}
		}
		...
		for(var5 = 0; var5 < this.boundingBox.bbWidth(); var5 += 4) {
			...
			if(var7 != null) {
				var8 = var7.getStructureBoundingBox();
				this.field_35356_a.add(new StructureBoundingBox(var8.minX, var8.minY, this.boundingBox.maxZ - 1, var8.maxX, var8.maxY, this.boundingBox.maxZ));
			}
		}

		for(var5 = 0; var5 < this.boundingBox.bbDepth(); var5 += 4) {
			var5 += var3.nextInt(this.boundingBox.bbDepth());
			if(var5 + 3 > this.boundingBox.bbDepth()) {
				break;
			}
			...
			if(var7 != null) {
				var8 = var7.getStructureBoundingBox();
				this.field_35356_a.add(new StructureBoundingBox(this.boundingBox.minX, var8.minY, var8.minZ, this.boundingBox.minX + 1, var8.maxY, var8.maxZ));
			}
		}
		...
		for(var5 = 0; var5 < this.boundingBox.bbDepth(); var5 += 4) {
			...
			if(var7 != null) {
				var8 = var7.getStructureBoundingBox();
				this.field_35356_a.add(new StructureBoundingBox(this.boundingBox.maxX - 1, var8.minY, var8.minZ, this.boundingBox.maxX, var8.maxY, var8.maxZ));
			}
		}
