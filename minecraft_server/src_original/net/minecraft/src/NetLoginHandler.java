...
public class NetLoginHandler extends NetHandler {
	...
	public void doLogin(Packet1Login var1) {
		...
		if(var2 != null) {
			...
			var5.sendPacket(new Packet1Login("", var2.entityId, var3.getRandomSeed(), var3.getWorldInfo().func_46069_q(), var2.itemInWorldManager.getGameType(), (byte)var3.worldProvider.worldType, (byte)var3.difficultySetting, (byte)var3.worldHeight, (byte)this.mcServer.configManager.getMaxPlayers()));
