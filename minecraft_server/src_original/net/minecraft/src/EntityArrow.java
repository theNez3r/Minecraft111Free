...
public class EntityArrow extends Entity {
	...
	private double field_46011_m = 2.0D;
		...
		if(this.inGround) {
			...
			if(var3 != null) {
				if(var3.entityHit != null) {
					...
					int var20 = (int)Math.ceil((double)var19 * this.field_46011_m);
					...
					if(var3.entityHit.attackEntityFrom(var21, var20)) {
						if(var3.entityHit instanceof EntityLiving) {
							++((EntityLiving)var3.entityHit).recentlyHit;
							if(this.field_46010_n > 0) {
								float var23 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
								if(var23 > 0.0F) {
									var3.entityHit.addVelocity(this.motionX * (double)this.field_46010_n * (double)0.6F / (double)var23, 0.1D, this.motionZ * (double)this.field_46010_n * (double)0.6F / (double)var23);
								}
							}
						}
	...
	public void writeEntityToNBT(NBTTagCompound var1) {
		...
		var1.setDouble("damage", this.field_46011_m);
	}
	...
	public void readEntityFromNBT(NBTTagCompound var1) {
		...
		if(var1.hasKey("damage")) {
			this.field_46011_m = var1.getDouble("damage");
		}
	...
	public void func_46008_a(double var1) {
		this.field_46011_m = var1;
	}

	public double func_46009_j() {
		return this.field_46011_m;
	}

	public void func_46007_b(int var1) {
		this.field_46010_n = var1;
	}
}
