...
public class EntityList {
	...
	private static void func_46122_a(Class var0, String var1, int var2, int var3, int var4) {
		addMapping(var0, var1, var2);
		field_44015_a.put(Integer.valueOf(var2), new EntityEggInfo(var2, var3, var4));
	}
	...
	public static Entity func_44014_a(int var0, World var1) {
		Entity var2 = null;
	...
	static {
		...
		func_46122_a(EntityCreeper.class, "Creeper", 50, 894731, 0);
		func_46122_a(EntitySkeleton.class, "Skeleton", 51, 12698049, 4802889);
		func_46122_a(EntitySpider.class, "Spider", 52, 3419431, 11013646);
		addMapping(EntityGiantZombie.class, "Giant", 53);
		func_46122_a(EntityZombie.class, "Zombie", 54, '\uafaf', 7969893);
		func_46122_a(EntitySlime.class, "Slime", 55, 5349438, 8306542);
		func_46122_a(EntityGhast.class, "Ghast", 56, 16382457, 12369084);
		func_46122_a(EntityPigZombie.class, "PigZombie", 57, 15373203, 5009705);
		func_46122_a(EntityEnderman.class, "Enderman", 58, 1447446, 0);
		func_46122_a(EntityCaveSpider.class, "CaveSpider", 59, 803406, 11013646);
		func_46122_a(EntitySilverfish.class, "Silverfish", 60, 7237230, 3158064);
		func_46122_a(EntityBlaze.class, "Blaze", 61, 16167425, 16775294);
		func_46122_a(EntityMagmaCube.class, "LavaSlime", 62, 3407872, 16579584);
		addMapping(EntityDragon.class, "EnderDragon", 63);
		func_46122_a(EntityPig.class, "Pig", 90, 15771042, 14377823);
		func_46122_a(EntitySheep.class, "Sheep", 91, 15198183, 16758197);
		func_46122_a(EntityCow.class, "Cow", 92, 4470310, 10592673);
		func_46122_a(EntityChicken.class, "Chicken", 93, 10592673, 16711680);
		func_46122_a(EntitySquid.class, "Squid", 94, 2243405, 7375001);
