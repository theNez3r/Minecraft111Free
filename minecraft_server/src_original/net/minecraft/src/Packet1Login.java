...
public class Packet1Login extends Packet {
	...
	public Packet1Login(String var1, int var2, long var3, EnumWorldType var5, int var6, byte var7, byte var8, byte var9, byte var10) {
		this.username = var1;
		this.protocolVersion = var2;
		this.mapSeed = var3;
		this.field_46001_d = var5;
		this.worldType = var7;
		this.difficultySetting = var8;
		this.serverMode = var6;
		this.worldHeight = var9;
	...
	public void readPacketData(DataInputStream var1) throws IOException {
		...
		this.field_46001_d = EnumWorldType.func_46049_a(var2);
		if(this.field_46001_d == null) {
			this.field_46001_d = EnumWorldType.DEFAULT;
		}
	...
	public void writePacketData(DataOutputStream var1) throws IOException {
		...
		if(this.field_46001_d == null) {
			...
			writeString(this.field_46001_d.name(), var1);
		}
	...
	public int getPacketSize() {
		int var1 = 0;
		if(this.field_46001_d != null) {
			var1 = this.field_46001_d.name().length();
		}
