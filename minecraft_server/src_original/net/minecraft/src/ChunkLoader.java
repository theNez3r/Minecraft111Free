...
public class ChunkLoader implements IChunkLoader {
	...
	public static void storeChunkInCompound(Chunk var0, World var1, NBTTagCompound var2) {
		...
		List var13 = var1.func_41046_a(var0, false);
		if(var13 != null) {
	...
	public static Chunk loadChunkIntoWorldFromCompound(World var0, NBTTagCompound var1) {
		...
		var4.data = new NibbleArray(var1.getByteArray("Data"), var0.worldYBits);
		var4.skylightMap = new NibbleArray(var1.getByteArray("SkyLight"), var0.worldYBits);
		var4.blocklightMap = new NibbleArray(var1.getByteArray("BlockLight"), var0.worldYBits);
		var4.heightMap = var1.getByteArray("HeightMap");
		var4.isTerrainPopulated = var1.getBoolean("TerrainPopulated");
		if(!var4.data.isValid()) {
			var4.data = new NibbleArray(var4.blocks.length, var0.worldYBits);
		}

		if(var4.heightMap == null || !var4.skylightMap.isValid()) {
			var4.heightMap = new byte[256];
			var4.skylightMap = new NibbleArray(var4.blocks.length, var0.worldYBits);
			var4.generateSkylightMap();
		}

		if(!var4.blocklightMap.isValid()) {
			var4.blocklightMap = new NibbleArray(var4.blocks.length, var0.worldYBits);
			var4.func_348_a();
		}
		...
		if(var1.hasKey("TileTicks")) {
			...
			if(var12 != null) {
				for(int var14 = 0; var14 < var12.tagCount(); ++var14) {
					...
					var0.func_41045_d(var15.getInteger("x"), var15.getInteger("y"), var15.getInteger("z"), var15.getInteger("i"), var15.getInteger("t"));
				}
			}
		}
