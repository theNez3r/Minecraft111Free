...
public class ChunkProviderHell implements IChunkProvider {
				...
				for(int var11 = 0; var11 < this.worldObj.worldHeight / 8; ++var11) {
					...
					for(int var30 = 0; var30 < 8; ++var30) {
						...
						for(int var41 = 0; var41 < 4; ++var41) {
							int var42 = var41 + var9 * 4 << this.worldObj.xShift | 0 + var10 * 4 << this.worldObj.worldYBits | var11 * 8 + var30;
							int var43 = 1 << this.worldObj.worldYBits;
							double var44 = 0.25D;
							double var46 = var33;
	...
	public void func_4061_b(int var1, int var2, byte[] var3) {
		int var4 = this.worldObj.worldHeight - 64;
		...
		for(int var7 = 0; var7 < 16; ++var7) {
			for(int var8 = 0; var8 < 16; ++var8) {
				...
				for(int var15 = this.worldObj.worldYMask; var15 >= 0; --var15) {
					int var16 = (var8 * 16 + var7) * this.worldObj.worldHeight + var15;
					if(var15 >= this.worldObj.worldYMask - this.hellRNG.nextInt(5)) {
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		for(var6 = 0; var6 < 8; ++var6) {
			...
			var8 = this.hellRNG.nextInt(this.worldObj.worldHeight - 8) + 4;
		...
		for(var7 = 0; var7 < var6; ++var7) {
			...
			var9 = this.hellRNG.nextInt(this.worldObj.worldHeight - 8) + 4;
		...
		for(var7 = 0; var7 < 10; ++var7) {
			var8 = var4 + this.hellRNG.nextInt(16) + 8;
			var9 = this.hellRNG.nextInt(this.worldObj.worldHeight);
			var10 = var5 + this.hellRNG.nextInt(16) + 8;
		...
		if(this.hellRNG.nextInt(1) == 0) {
			var7 = var4 + this.hellRNG.nextInt(16) + 8;
			var8 = this.hellRNG.nextInt(this.worldObj.worldHeight);
			var9 = var5 + this.hellRNG.nextInt(16) + 8;
	...
	public List func_40181_a(EnumCreatureType var1, int var2, int var3, int var4) {
		if(var1 == EnumCreatureType.monster && this.genNetherBridge.func_40204_a(var2, var3, var4)) {
			return this.genNetherBridge.func_40205_b();
		} else {
